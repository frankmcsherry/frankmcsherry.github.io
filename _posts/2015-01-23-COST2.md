...
<tr> <td>Single thread</td> <td align="right">1</td> <td align="right">242s</td><td align="right">256s</td><td align = "right">XXXXXs*</td></tr>
...
*: An earlier version had 23,653 seconds as the number for pagerank. Unfortunately, the code was set to do only ten iterations (in order to compare to GraphX, whose scaling measurements are for only ten iterations). The twenty iteration measurement is running now, and should register at a little less than twice this number. We apologize for the error.
